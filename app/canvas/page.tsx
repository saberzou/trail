...
export default function CanvasPage() {
  return (
    <>
      <Link
        aria-label="Settings"
        className="fixed top-4 right-4 z-50 inline-flex h-8 w-8 items-center justify-center rounded border border-[#c9c8bd] bg-white text-[#273321] shadow-sm hover:bg-[#f0f0e8]"
        href="/settings"
      >
        <svg
          aria-hidden="true"
